...
void initTIM6(void) {
    // Habilitar reloj para TIM6
    RCC->APB1ENR |= RCC_APB1ENR_TIM6EN;

    // Configurar prescaler y auto-reload para ~10 ms de antirrebote
    TIM6->PSC = 18000 - 1; // SYSCLK=180MHz -> 18000 -> 10 kHz
    TIM6->ARR = 100 - 1;   // 100 ciclos -> 10 ms
    TIM6->CR1 = 0;          // temporizador detenido
    TIM6->DIER |= TIM_DIER_UIE; // habilitar interrupción por actualización
